...
public class KycService {
 ...
 // ---------------- View Documents ----------------
    ...
    public KYCDocumentDetailDTO viewDocumentDetailById(String docId) {
        KYCDocument doc = kycRepository.findById(docId)
                .orElseThrow(() -> new RuntimeException("Document not found: " + docId));
        KYCDocumentDetailDTO dto = new KYCDocumentDetailDTO();
        dto.setDocId(doc.getDocId());
        dto.setCustomerId(doc.getCustomerId());
        dto.setDocType(doc.getDocType());
        dto.setFileName(doc.getFileName());
        dto.setFileBase64(doc.getFileBase64());  // :point_left: include base64
