...
import com.ofss.dto.KYCDocumentDetailDTO;
...
public class KycController {
    ...
    @Operation(summary = "Get detailed KYC document (includes Base64 file content)")
    public ResponseEntity<KYCDocumentDetailDTO> viewDocumentWithFile(
            @Parameter(description = "Document ID") @PathVariable String docId
    ) {
        return ResponseEntity.ok(kycService.viewDocumentDetailById(docId));
    }
