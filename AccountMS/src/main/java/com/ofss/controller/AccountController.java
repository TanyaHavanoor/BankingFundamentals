...
public class AccountController {
 ...
 // Endpoint to fetch all accounts
    ...
    @Operation(summary = "Delete an account by accountId using SoftDelete")
    @DeleteMapping("/SoftDelete/{accountId}")
    public ResponseEntity<String> softDeleteSingleAccount(@PathVariable String accountId) {
        accountService.softDeleteAccount(accountId);
        return ResponseEntity.ok("Account set to INACTIVE: " + accountId);
    }
