...
public class AccountService {
    ...
    public Account softDeleteAccount(String accountId) {
        Account account = getAccountById(accountId); // fetch the account
        account.setAccountStatus("INACTIVE");        // mark as inactive
        return accountRepository.save(account);      // save the change
    }
